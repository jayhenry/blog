...
### 先看单次 
`16x8x8`
 MMA 对 C fragment 的要求

以 `C` 为例，单次 `16x8x8` MMA 的输出块大小是：

<img src="https://www.zhihu.com/equation?tex=16%20%5Ctimes%208%20%3D%20128%5C%5C" alt="16 \times 8 = 128\\" class="ee_img tr_noresize" eeimg="1">

warp 一共有 32 个线程，因此平均到每个线程上，就是：

<img src="https://www.zhihu.com/equation?tex=128%20/%2032%20%3D%204%5C%5C" alt="128 / 32 = 4\\" class="ee_img tr_noresize" eeimg="1">
...
<img src="https://www.zhihu.com/equation?tex=%28M%2CN%2CK%29%20%3D%20%2816%2C16%2C8%29%5C%5C" alt="(M,N,K) = (16,16,8)\\" class="ee_img tr_noresize" eeimg="1">
